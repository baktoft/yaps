...
doRunYaps <- function(inp, silent=TRUE, max_iter=1000, getPlsd=TRUE, getRep=TRUE, opt_fun='nlminb', opt_controls=list(), tmb_smartsearch=TRUE){
	...
	track <- extractTrack(inp, pl, plsd)
