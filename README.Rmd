...
YAPS was recently archived on CRAN due to dependence on a deprecated package (splusTimeSeries). We are currently working on an updated and improved version.
