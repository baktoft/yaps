...
This how-to guide is intended to provide users with an example work-flow to start from. The guide walks through the entire workflow from raw data collected by PPM-based systems (Vemco VR2/VPS) to final tracks. It shows how to use new functions added to YAPS enabling an easy and approachable (but fine tuned) synchronization. 

Click here for a [quick example running YAPS on simulated data](#exampleSimuluation)
